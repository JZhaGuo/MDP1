...
Tenemos un total de `r sum(children)` encuestados. Creamos a continuación las matrices de frecuencias relativas, condicionadas a filas, a columnas, y marginales de filas y columnas:
